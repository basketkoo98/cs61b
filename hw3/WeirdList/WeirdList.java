...
public class WeirdList {
  ...
  public WeirdList(int head, WeirdList tail) {
    ...
    public WeirdList map(IntUnaryFunction func) {
        ...
        return new WeirdList(func.apply(head),tail.map(func));  // TODO: REPLACE THIS LINE
    }

    /** The empty sequence of integers. */

    public static final WeirdList EMPTY = new EmptyWiredList();  // TODO: REPLACE THIS LINE

    public static class EmptyWiredList extends WeirdList {
        public EmptyWiredList() {
            super(0, null);
        }
